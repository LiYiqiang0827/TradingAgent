"""
service_top_inst.py - 龙虎榜机构买卖明细更新

数据源:tushare pro.top_inst
文档:https://tushare.pro/document/2?doc_id=107

用法:
  python3 service_top_inst.py  # 增量
  python3 service_top_inst.py --start-date 20201201 --end-date 20240930
"""
...
def main():
    parser = argparse.ArgumentParser(description="Update 龙虎榜机构买卖明细(tushare pro.top_inst)")
