"""
service_kpl_list.py - 开盘啦涨停榜更新

用法:
  python3 service_kpl_list.py --trade-date 20240909
  python3 service_kpl_list.py --start-date 20240101 --end-date 20241231
  python3 service_kpl_list.py  # 增量
"""
import sys
import argparse
import time
